...
class Auth extends MX_Controller {
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				redirect('games/creategame', 'refresh');
			}
			else
			{
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->load->view('auth_view/change_password', $data);
		}
		else
		{
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->load->view('auth_view/forgot_password', $data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->load->view('auth_view/reset_password', $data);
			}
			else
			{
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->load->view('auth_view/deactivate_user', $data);
		}
		else
		{
	...
	function create_user()
    {
        ...
        else
        {
            ...
            $this->load->view('auth_view/create_user', $data);
        }
    }
	...
	function edit_user($id)
	{
		...
		$this->load->view('auth_view/edit_user', $data);
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->load->view('auth_view/create_group', $data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->load->view('auth_view/edit_group', $data);
	}
